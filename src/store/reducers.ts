import { SET_FAVORITE_MOVIE, REMOVE_FAVORITE_MOVIE, SET_VERIFIED_ADULT_STATUS } from './actions';
...
export function appReducer(state: AppState = initialState, action: any) {
    switch (action.type) {
        ...
        case REMOVE_FAVORITE_MOVIE:
            return {
                ...state,
                favouriteMovies: state.favouriteMovies.filter((id) => id !== action.movieID),
            };
